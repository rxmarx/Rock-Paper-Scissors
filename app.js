//CachingDom is nothing but Caching the dom which means storing data into variable, and as a constant
let userScore = 0;
let computerScore = 0;
...
function win(userChoice, computerChoice) {
    const smallUserWord = "UserChoice".fontsize(3).sup();
    const smallCompWord = "CompChoice".fontsize(3).sup();
